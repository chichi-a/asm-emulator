...
"""
def add(register_1,register_2,register_0,registers):
...
"""
def addi(register_1,register_0,literal_value,registers):
    if (register_1 in valid_register):
        registers[register_0] = registers[register_1] + literal_value
    else:
        raise ValueError("Use a valid register for your assembly code")
...
in reg[register_0] we write reg[register_1] * reg[register_2]
"""
def mul(register_1,register_2,register_0,registers):
    if (register_1 in valid_register) & (register_2 in valid_register):
        registers[register_0] = registers[register_1] * registers[register_2]
    else:
        raise ValueError("Use a valid register for your assembly code")
...
in reg[register_0] we write reg[register_1] * reg[register_2]
"""
def muli(register_0,register_1,literal_value,registers):
    if (register_1 in valid_register):
       registers[register_0] = registers[register_1] * literal_value
    else:
        raise ValueError("Use a valid register for your assembly code")
...
in reg[register_0] we write reg[register_1] / reg[register_2]
"""
def div(register_0,register_1,register_2,registers):
    if (register_1 in valid_register) & (register_2 in valid_register):
        registers[register_0] =  registers[register_1] / registers[register_2]
    else:
        raise ValueError("Use a valid register for your assembly code")